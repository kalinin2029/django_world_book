...
class Author(models.Model):
    ...
    date_of_dead = models.DateField(help_text="Введите дату смерти автора",
...
class Book(models.Model):
    ...
    def get_absolute_url(self):
        #Возвращает url-адресс для доступа к определенному экземпляру книги
        return reverse('book-detail', args=[str(self.id)])

    # Функция для отображения авторов в списке книг
...
class Status(models.Model):
    name = models.CharField(max_length=20,
                            help_text="Введите статус экзепляра книгик",
...
class BookInstance(models.Model):
    ...
    imprint = models.CharField(max_length=200,
                               help_text="Введите наименование издательстава",
